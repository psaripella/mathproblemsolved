...
my $key_text ="differential-calculus".${problem} ;
...
my $root_directory = '/home/calculus/www/www/images/differential-calculus/problems/';
my $logical_root_directory = 'images/differential-calculus/problems/'; 
