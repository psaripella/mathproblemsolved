...
my $key_text ="trig-precalc".${problem} ;
...
my $root_directory = 'http://localhost/projects/mathproblemsolved/images/${product}/problems/';
my $logical_root_directory = 'images/trig-precalc/problems/'; 
