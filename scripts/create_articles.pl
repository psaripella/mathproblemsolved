...
my $root_directory = "/home/calculus/www/www/images/${product}/problems/";
my $logical_root_directory = "images/${product}/problems/";
...
my $latex_insert = $latex_text_hash_ref->{ $product_index} ;
my $search_txt = $search_text_hash_ref->{ $product_index} ; 
