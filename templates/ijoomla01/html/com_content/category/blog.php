...
<?php if (!empty($this->intro_items)) : ?>
	...
	<?php endif; ?>
	<div class="item column-<?php echo $rowcount;?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?> <?php if ($this->columns==1) {echo 'span12';} elseif ($this->columns==2) {echo 'span6';} elseif ($this->columns==3) {echo 'span4';} elseif ($this->columns==4) {echo 'span3';} ?>">
		<?php
			$this->item = &$item;
			echo $this->loadTemplate('item');
		?>
