<?php /**  * @copyright	Copyright (C) 2012 iJoomlaTemplates.com - All Rights Reserved. **/ defined( '_JEXEC' ) or die( 'Restricted access' );
...
<div class="isonic">Design by <a href="http://ijoomlatemplates.com/" target="_blank" title="joomla free design">Joomla 3.0 Templates</a></div>
<?php } ?>
<div class="clr"></div>
</div></div>
