...
class JFormFieldProfile extends JFormField {
        ...
        public function getInput() {
        	...
        	if((($ats_sl_profile_id != $ats_share_profile_id) ||  ($ats_follow_profile_id != $ats_share_profile_id)) && ($ats_share_profile_id !="")) {
        		$ats_sl_params['ats_profile_id'] = (string) $ats_share_profile_id;
        		...
        		$ats_follow_params['atf_profile_id'] = (string) $ats_share_profile_id;
        		...
        		$ats_db->query();        		
        	} else if($ats_share_profile_id == "" && ($ats_follow_profile_id!="" || $ats_sl_profile_id!="")) {
        		$ats_share_params['profile_id'] = (string) ($ats_sl_profile_id!="" ? $ats_sl_profile_id : $ats_follow_profile_id);
        		if($ats_share_params['profile_id']){
        	...
        	if(!$ats_share_profile_id)
        		$ats_share_profile_id = "Your Profile ID";

        	return '<input type="text" id="'.$this->id.'" name="'.$this->name.'" value="'.$ats_share_profile_id.'"/>';
        }
}
