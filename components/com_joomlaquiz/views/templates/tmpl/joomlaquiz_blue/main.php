...
function jq_HidePanel_go() {
	...
	tbl_max_step = end_index;
	setTimeout("jq_StepHidePanel("+end_index+")", 100);
}
...
JQ_MM_preloadImages(
	...
	'{$live_url}components/com_joomlaquiz/views/templates/tmpl/{$tmpl_folder}/images/tab_2_l.png',
	'{$live_url}components/com_joomlaquiz/views/templates/tmpl/{$tmpl_folder}/images/tab_2_r.png',
...
<div class="jq_outter">
	...
	<h3><span id="jq_quiz_container_title"><!-- Quiz header --></span></h3>
