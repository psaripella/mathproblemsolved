...
class JoomlaQuiz_template_class extends JoomlaQuizTemplateClass {
	...
	public static function JQ_getTemplateName() {
		return 'joomlaquiz_pretty_green';
	}
...
preload([
	'{$live_url}components/com_joomlaquiz/views/templates/tmpl/{$tmpl_folder}/images/check_off_green.png',
	...
	'{$live_url}components/com_joomlaquiz/views/templates/tmpl/{$tmpl_folder}/images/radio_off_green.png',
