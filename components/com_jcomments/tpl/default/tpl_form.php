...
<p>
	<span>
		<input id="comments-form-name" type="text" name="name" value="" placeholder="NAME (Required)" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
...
<p>
	<span>
		<textarea id="comments-form-comment" name="comment" cols="65" rows="8" tabindex="5" placeholder="COMMENT"></textarea>
	</span>
</p>
<?php
...
<p>
	<span>
		...
		<p style="font-size: 11px;"><i>Type the above word in picture in the box</i></p>
	</span>
</p>
<?php
			}
