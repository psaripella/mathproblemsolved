...
$input = new Babelu_examsHtmlTextarea(array('name' => $name, 'placeholder' => JText::_('COM_BABELU_EXAMS_PLACEHOLDER')), array('problem', 'short_essay'));

$input->setInnerHtml($user_response[0]);
