...
$context = 'problems';
$editUrl = 'index.php?option=com_babelu_exams&task=problem.edit&id=';
	...
	<thead>
		<tr>
			...
			<th width="1%" class="nowrap center">
             ...
             <th class='left' style="max-width:550px;" >
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_PROBLEMS_PROBLEM_TEXT', 'a.problem_text', $listDirn, $listOrder); ?>
			</th>
			<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_PROBLEMS_STANDARD', 'a.standard', $listDirn, $listOrder); ?>
			</th>
			<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_PROBLEMS_GROUP_ID', 'a.group_id', $listDirn, $listOrder); ?>
			</th>
			<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_PROBLEMS_LEVEL', 'a.level', $listDirn, $listOrder); ?>
			</th>
			<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_PROBLEMS_POINT_VALUE', 'a.point_value', $listDirn, $listOrder); ?>
			</th>
			<th width="1%" class="nowrap center hidden-phone">
	...
	<?php foreach ($this->items as $i => $item) :?>
		...
		<tr class="row<?php echo $i % 2; ?>">     
			...
			<td>
				...
				<?php endif; ?>
				<?php $clean_text = substr(strip_tags($item->problem_text), 0, 200);?>
			...
			<td>
				<?php if ($item->standard != ''):?>
					<?php echo $item->standard; ?>
				<?php else:?>
					<?php echo JText::_('COM_BABELU_EXAMS_PROBLEMS_NO_STANDARD');?>
				<?php endif;?>
			</td>
			<td>
