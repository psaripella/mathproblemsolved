...
$context = 'groups';
$editUrl = 'index.php?option=com_babelu_exams&task=group.edit&id=';
	...
	<thead>
		<tr>
			...
			<th class='center' width="5%">
				<?php echo JText::_('COM_BABELU_EXAMS_GROUPS_PROBLEM_COUNT'); ?>
			</th>
	...
	<?php foreach ($this->items AS $i => $item): ?>
		...
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_babelu_exams&task=group.edit&id='.(int) $item->id); ?>">
