...
?>
<form action="<?php echo JRoute::_('index.php?option=com_babelu_exams&view=groups&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
...
<table class="table table-striped adminlist" id="groupList">
		<thead>
			<tr>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_GROUPS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
