		...
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td>
				<?php if ($item->user_name != ''):?>
					<?php if ($canChange) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_babelu_exams&task=exam_state.edit&id='.(int) $item->exam_state_id).'&tmpl=component'; ?>" class="modal" rel="{size: {x: 418, y: 400}}">
