...
<table class="table table-striped" id="adminList">
	<thead>
		<tr>
			...
			<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_CATEGORIES_HEADER_TITLE', 'a.title', $listDirn, $listOrder); ?>
			</th>
			
			<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BABELU_EXAMS_CATEGORIES_HEADER_ACCESS', 'a.access', $listDirn, $listOrder); ?>
			</th>
