...
class JFormFieldModal_Article extends JFormField
{
	...
	protected function getInput()
	{
		...
		if (empty($title)) 
		{
			$title = JText::_('COM_BABELU_EXAMS_SELECT_AN_ARTICLE');
		}
		...
		$html[] = '	<a class="modal" title="'.JText::_('COM_BABELU_EXAMS_CHANGE_ARTICLE').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">';
		$html[] = JText::_('COM_BABELU_EXAMS_CHANGE_ARTICLE_BUTTON');
		$html[] = '</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
